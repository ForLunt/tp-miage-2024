...
Une architecture hexagonale permet de séparer les parties code métier des donné si une des deux est modifier cele n'impactera pas.
ça facilite la maintenance du code et la stabilité
